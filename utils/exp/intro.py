...
ax.add_patch(rect)
t=plt.text(tssd_det[0][0], tssd_det[0][1], '0:hamster',fontdict=font_text)
t.set_bbox(dict(facecolor='r', alpha=0.5, edgecolor='r'))
ax.spines['right'].set_color('none')
ax.spines['left'].set_color('none')
ax.spines['bottom'].set_color('none')
...
ax.add_patch(rect)
t=plt.text(tssd_det[1][0], tssd_det[1][1], '0:hamster',fontdict=font_text)
t.set_bbox(dict(facecolor='r', alpha=0.5, edgecolor='r'))
ax.spines['bottom'].set_color('none')
ax.spines['top'].set_color('none')
ax.set_xticks([])
...
ax.add_patch(rect)
t=plt.text(tssd_det[2][0], tssd_det[2][1], '0:hamster',fontdict=font_text)
t.set_bbox(dict(facecolor='r', alpha=0.5, edgecolor='r'))
ax.spines['bottom'].set_color('none')
ax.spines['top'].set_color('none')
ax.set_xticks([])
